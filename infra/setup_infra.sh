...
echo "Current ipAddress: $ipAddress"
...
docker run -d --name $selenoid_ui_container_name \
            -p 80:8080 \
            aerokube/selenoid-ui:latest-release --selenoid-uri "http://$ipAddress:4444"
